...
const Landing = () => {
    return (
        <div className=" font-montserrat my-16 sm:my-32">
            <div className=" flex flex-col sm:flex-row sm:w-2/3 mx-auto">
                ...
                <div className=" flex flex-col p-10 sm:p-0 sm:w-1/2 justify-center">
                    ...
                    <button className=" w-40 mt-6 h-12 text-white font-semibold rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 align-middle">Contact me<i className="fas fa-angle-double-right ml-3 text-lg align-middle"></i></button>
                </div>
            </div>
        </div>
    )
