...
const Footer = () => {
    return (
        <div className=" flex flex-col sm:flex-row bg-violet-800 text-white mt-16 sm:mt-32 bg-opacity-80" id="footer">
            <div className=" flex flex-col p-6 sm:w-2/5 sm:px-12 sm:py-8">
            ...
            <div className=" flex sm:w-2/5 my-auto px-6">
            ...
            <div className=" sm:w-1/5 text-3xl my-auto p-10">Anand &#xa9; 2022</div>
        </div>
    )
}
